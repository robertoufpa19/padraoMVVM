package com.example.padraomvvm.adapters
...
import com.example.padraomvvm.databinding.ResItemLiveBinding
...
class MainViewHolder(val binding: ResItemLiveBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(live: Live, onItemClicked: (Live) -> Unit) {
        ...
        binding.textViewTituloLive.text = live.title
        binding.textViewAutorLive.text = live.author
        ...
        Glide.with(itemView.context)
            ...
            .into(binding.imageViewLive) // thumbnail
